...
// //     await axios.post("http://localhost:5000/api/orders", { ...formData, cartItems: cart });

// //     alert("Order placed successfully!");

// //     // Clear the cart without refreshing the page
// //     clearCart();
// //   };
...
//     console.log("Order Details:", orderDetails); // 🖨️ Print order details in the console
...
const Cart = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("📦 Order Details:", orderDetails); // 🖨️ Print order details in console
